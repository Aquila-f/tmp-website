---
title: "子彈思考整理術：讀書筆記"
description: "用 Rapid Logging、Collection 與 Migration，追蹤過去、整理現在並規劃未來。"
kind: book-note
date: 2025-01-16
...
![日常進入自動駕駛循環](./images/autopilot-cycle.png)
...
![Rapid Logging 的任務、事件與筆記符號](./images/rapid-logging.png)
...
![實際使用的 Daily Log](./images/daily-log.jpg)

![Monthly Log 範例之一](./images/monthly-log-1.png)

![Monthly Log 範例之二](./images/monthly-log-2.png)

![Future Log 範例](./images/future-log.png)
...
![Migration 的整理流程](./images/migration.png)
